    ...
    <div className="flex flex-col h-full max-h-[calc(90vh-80px)]">
      ...
      <div className="flex justify-between items-center border-b dark:border-gray-700 pb-3 mb-3">
        <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 flex items-center">
          ...
          Palette Manager <span className="ml-2 text-sm text-blue-500 dark:text-blue-400">({selectedCount} colors)</span>
        </h2>
        <button 
          onClick={onClose}
      ...
      <div className="mb-4 text-xs text-gray-600 dark:text-gray-400 bg-blue-50 dark:bg-blue-900/20 p-2 rounded-md border border-blue-100 dark:border-blue-800/30">
        <p className="flex items-start">
          ...
          Select the perler bead color system to use here. You can choose a preset palette, then manually add or remove specific color codes as needed. Click the &quot;Save and Apply&quot; button at the bottom when done.
        </p>
      </div>
          ...
          <div key={prefix} className="mb-3 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
            ...
            >
              <div className="flex items-center">
                <span className="font-medium text-gray-800 dark:text-gray-200">{prefix} Series</span>
                <span className="ml-2 text-xs text-gray-500 dark:text-gray-400">
                  ({colorGroups[prefix].length} colors)
                </span>
              </div>
