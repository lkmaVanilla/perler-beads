      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-md w-full p-6 space-y-4">
        ...
        <div className="text-sm text-gray-600 dark:text-gray-300 space-y-3">
            ...
            <div className="flex items-start space-x-2">
              ...
              <div>
                ...
                <p className="text-yellow-700 dark:text-yellow-300">
                  After entering Focus Mode, you will not be able to return to the current editing interface. We recommend downloading the current data file (CSV format) first for future re-import.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-2">
            <p>Focus Mode Features:</p>
            <ul className="text-xs space-y-1 text-gray-500 dark:text-gray-400">
              <li>• Mobile-optimized perler beads assistant</li>
              <li>• Color guidance and progress tracking</li>
              <li>• Touch controls and zoom viewing</li>
              <li>• Current editing state will be lost on exit</li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col space-y-2 pt-4">
          ...
          >
            ...
            <span>Download Data File and Enter</span>
          </button>
