    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-start justify-end">
      <div className="w-80 max-w-[90vw] h-full bg-white shadow-lg flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6">
          {/* 引导设置 */}
          <div>
            <h3 className="text-base font-medium text-gray-800 mb-3">Smart Guidance</h3>
            <div className="space-y-3">
              <label className="flex items-center">
                ...
                />
                <div>
                  <div className="text-sm font-medium text-gray-700">Nearest First</div>
                  <div className="text-xs text-gray-500">Recommend the nearest cell</div>
                </div>
              </label>
              ...
              <label className="flex items-center">
                ...
                />
                <div>
                  <div className="text-sm font-medium text-gray-700">Largest First</div>
                  <div className="text-xs text-gray-500">Prioritize large color block areas</div>
                </div>
              </label>
              ...
              <label className="flex items-center">
                ...
                />
                <div>
                  <div className="text-sm font-medium text-gray-700">Edge First</div>
                  <div className="text-xs text-gray-500">Complete edges first, then fill interior</div>
                </div>
              </label>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <label className="flex items-center justify-between">
                <div>
                  <div className="text-sm font-medium text-gray-700">Show Section Lines</div>
                  <div className="text-xs text-gray-500">Divide canvas into sections for easier navigation</div>
                </div>
                <input
                  type="checkbox"
              ...
              <label className="flex items-center justify-between">
                <div>
                  <div className="text-sm font-medium text-gray-700">Celebration Animation</div>
                  <div className="text-xs text-gray-500">Show confetti effect when color is completed</div>
                </div>
                <input
                  type="checkbox"
          ...
          {/* 进度重置 */}
          <div>
            <h3 className="text-base font-medium text-gray-800 mb-3">Data Management</h3>
            <div className="space-y-3">
          ...
          {/* 关于信息 */}
          <div>
            <h3 className="text-base font-medium text-gray-800 mb-3">About</h3>
            <div className="text-sm text-gray-600 space-y-2">
              <p>Focus Mode v1.0</p>
              <p>Mobile-optimized perler beads assistant</p>
              <div className="pt-2 text-xs text-gray-500">
                <p>💡 Tip: Long press cells to mark quickly</p>
                <p>💡 Tip: Pinch to zoom for details</p>
              </div>
            </div>
          </div>
        </div>
